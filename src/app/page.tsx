    ...
    <EditCtx.Provider value={{ editing, content, save }}>
      <main>
        ...
        <div className="fixed bottom-6 right-5 z-[150] flex flex-col gap-3">
          {/* 肉包 #5044 2026-06-01: 按鈕字改成「給辛苦的妳」 */}
          <a href="/dear-you"
            className="w-[68px] h-[68px] float-btn flex flex-col items-center justify-center">
            <span className="corner-tr" /><span className="corner-bl" />
            <span className="text-gold/90 text-xs font-medium leading-tight">給辛苦</span>
            <span className="text-gold/90 text-xs font-medium leading-tight">的妳</span>
          </a>
          <a href="/experience"
            className="w-[68px] h-[68px] float-btn flex flex-col items-center justify-center">
            <span className="corner-tr" /><span className="corner-bl" />
